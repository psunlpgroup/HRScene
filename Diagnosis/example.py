...
model = Llama32(model_path="/scratch1/wmz5132/models/huggingface/Llama-3.2-11B-Vision-Instruct", torch_dtype=torch.bfloat16, device_map="cuda:1")
tester = DiagnosisTester(model=model, dataset_name="complexgrid_3x3", num_samples=10)
